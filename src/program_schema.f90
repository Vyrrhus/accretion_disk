...
REAL(KIND=XP), PARAMETER     :: FRACTION_DT_VISQ     = 1.0E-3_XP   !! Fraction du pas de temps visqueux
REAL(KIND=XP), PARAMETER     :: FRACTION_DT_INSTABLE = 1.0E-10  !! Fraction du pas de temps instable

INTEGER, PARAMETER               :: IS_REPRISE       = 1
INTEGER, PARAMETER               :: IS_SCHEMA_STABLE = 0
...
IF (IS_SCHEMA_STABLE == 1) THEN
    ...
    DO i_temps = 1,1000
        ...
        IF (TIME>71 .or. i_temps==1000) THEN
        ...
        CALL COMPUTE_Q_ADV_AD(DELTA_T_VISQ_AD, S_AD_SAVE)
        CALL COMPUTE_EQS
        TIME_AD = TIME_AD + (DELTA_T_VISQ_AD - j_temps*DELTA_T_TH_AD)
