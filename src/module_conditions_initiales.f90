...
!===================================================================================================
    ...
    !---------------------------------------------------------------------------------------------------
        ...
        F_RG = 1.0_XP - (X_AD**2.0_XP/3.0_XP)**(-1._XP/2._XP)
        ...
        S_AD_INI    = 52.0_XP / S_0 * ALPHA**(-4.0_XP/5.0_XP) * F_RG**(7.0_XP/10.0_XP)                    &
                    * (M_0_DOT * M_0_DOT_FRAC / (10E13_XP))**(7.0_XP/10.0_XP) * (M/M_O)**(1.0_XP/4.0_XP)  &
                    * (R_S / 10.0_XP**8._XP)**(-3.0_XP/4.0_XP) * X_AD**(-1.0_XP/2.0_XP)
