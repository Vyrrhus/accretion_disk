...
! --------------------------------------------------------------------------------------------------------------------------------------
   ...
   CALL calc_H(Temp_S,x_ad(ipos),Omega_S,Sa,Ha)                                                                    !calcul de H au point a
   !PRINT*, "H= ", Ha
   
   CALL calc_H(Temp_S,x_ad(ipos),Omega_S,Sb,Hb)                                                                    !calcul de H au point b
   ...
   IF (mince .eqv. .true.) THEN                                                                               !Calculs pour la branche mince
      ...
      DO WHILE(eps>prec .and. counter<100)
   ...
   ELSE                                                                                                  !Calculs pour la branche épais
      ...
      DO WHILE(eps>prec .and. counter<100)
         ...
         CALL calc_H(Temp_S,x_ad(ipos),Omega_S,Sc,Hc)
